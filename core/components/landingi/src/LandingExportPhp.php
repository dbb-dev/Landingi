...
/**
 * This Class is based on the auto generation of Landingi PHP export.
 * Do not change modify this class but instead export, if needed, a newer class from Landingi platform
 *
